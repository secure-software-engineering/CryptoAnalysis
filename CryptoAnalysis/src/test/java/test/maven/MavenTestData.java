...
public class MavenTestData {
	...
	public void prepareData() {
		...
		errorDescs.add(MavenJar.findingType.TRUE_POSITIVE.toString() + " - Value couldn't be extracted statically for parameter of getInstance.");
		jar1.addErrors(
		...
		errorDescs.add(MavenJar.findingType.FALSE_NEGATIVE.toString());
		errorDescs.add(MavenJar.findingType.FALSE_NEGATIVE.toString());
		errorDescs.add(MavenJar.findingType.FALSE_NEGATIVE.toString());
		errorDescs.add(MavenJar.findingType.FALSE_NEGATIVE.toString());
		jar1.addErrors(
		...
		errorDescs.add(MavenJar.findingType.FALSE_POSITIVE.toString() + " - call to load is done in loadKeyStoreFromFile method.");
		jar1.addErrors(
		...
		errorDescs.add(MavenJar.findingType.TRUE_POSITIVE.toString()
		...
		errorDescs.add(MavenJar.findingType.TRUE_POSITIVE.toString() + " - call to load is done in loadKeyStoreFromFile method in other path");
		jar1.addErrors(
		...
		errorDescs.add(MavenJar.findingType.TRUE_POSITIVE.toString() + " - parameter should be any of SHA-256, SHA-384, SHA-512");
		...
		errorDescs.add(MavenJar.findingType.FALSE_POSITIVE.toString()
		...
		errorDescs.add(MavenJar.findingType.FALSE_POSITIVE.toString() + " - ForbiddenError is being called on cipher.init");
		jar2.addErrors(
		...
		errorDescs.add(MavenJar.findingType.TRUE_POSITIVE.toString() + " - key is just a parameter. It can be passed as random or not.");
		jar2.addErrors(
				"<com.github.t3t5u.common.util.SecurityUtils: byte[] init(javax.crypto.Cipher,int,java.security.Key)>",
		...
		errorDescs.add(
				MavenJar.findingType.TRUE_POSITIVE.toString() + " - We cannot tell anything about this as analysis did not have enough information.");
		jar2.addErrors(
				"<com.github.t3t5u.common.util.SecurityUtils: byte[] doDecrypt(javax.crypto.Cipher,java.security.Key,byte[])>",
				ImpreciseValueExtractionError.class, errorDescs);
		errorDescs.clear();
		...
		errorDescs.add(MavenJar.findingType.TRUE_POSITIVE.toString() + " - We cannot determine the value of privateKey statically in this context.");
		jar2.addErrors(
		...
		errorDescs.add(MavenJar.findingType.TRUE_POSITIVE.toString() + " - We cannot determine the value statically in this context.");
		errorDescs.add(MavenJar.findingType.FALSE_POSITIVE.toString() + " - Two errors are shown for same variable preparedIV and preparedGCM");
		errorDescs.add(MavenJar.findingType.FALSE_POSITIVE.toString() + " - Two errors are shown for same variable preparedIV and preparedGCM");
		jar2.addErrors(
		...
		errorDescs.add(MavenJar.findingType.TRUE_POSITIVE.toString() + " - Order is not being followed. (line 19 of TrustAnchor.cryptsl)");
		errorDescs.add(MavenJar.findingType.TRUE_POSITIVE.toString() + " - Order is not being followed. (line 19 of TrustAnchor.cryptsl)");
		errorDescs.add(MavenJar.findingType.TRUE_POSITIVE.toString() + " - Order is not being followed. (line 19 of TrustAnchor.cryptsl)");
		errorDescs.add(MavenJar.findingType.TRUE_POSITIVE.toString() + " - Order is not being followed. (line 19 of TrustAnchor.cryptsl)");
		...
		errorDescs.add(MavenJar.findingType.TRUE_POSITIVE.toString() + " - reset is not called on message digest. (line 35 of MessageDigest.cryptsl)");
		jar3.addErrors(
		...
		errorDescs.add(MavenJar.findingType.TRUE_POSITIVE.toString() + " - first parameter is not generated properly. (line 31 of SSLContext.cryptsl)");
		errorDescs.add(MavenJar.findingType.TRUE_POSITIVE.toString() + " - second parameter is not generated properly. (line 32 of SSLContext.cryptsl)");
		jar3.addErrors("<io.rubrica.util.HttpClient: void disableSslChecks()>",
				RequiredPredicateError.class, errorDescs);
		errorDescs.clear();

		errorDescs.add(MavenJar.findingType.TRUE_POSITIVE.toString() + " - Parameter is of type string (line 47 in KeyStore.cryptsl)");
		...
		errorDescs.add(MavenJar.findingType.TRUE_POSITIVE.toString() + " - They are using X509TrustManager for which cryptsl file is not present.");
		errorDescs.add(MavenJar.findingType.TRUE_POSITIVE.toString()
		...
		errorDescs.add(MavenJar.findingType.TRUE_POSITIVE.toString() + " - KeyManager should be generated but is sent as null in first parameter.");
		errorDescs.add(MavenJar.findingType.TRUE_POSITIVE.toString() + " - They are using X509TrustManager for which cryptsl file is not present.");
		jar4.addErrors(
		...
		errorDescs.add(MavenJar.findingType.TRUE_POSITIVE.toString() + " - Randomization of second parameter is not up to the mark (Cipher)");
		errorDescs.add(MavenJar.findingType.TRUE_POSITIVE.toString() + " - Randomization of first parameter is not up to the mark. (SecretKeySpec)");
		errorDescs.add(MavenJar.findingType.TRUE_POSITIVE.toString()
		...
		errorDescs.add(MavenJar.findingType.FALSE_POSITIVE.toString() + " - repeated");
		errorDescs.add(MavenJar.findingType.FALSE_POSITIVE.toString() + " - repeated");
		errorDescs.add(MavenJar.findingType.FALSE_POSITIVE.toString() + " - repeated");
		errorDescs.add(MavenJar.findingType.TRUE_POSITIVE.toString()
		...
		errorDescs.add(MavenJar.findingType.TRUE_POSITIVE.toString()
				+ " - There is no enough information to calculate if the parameter is generated properly. It is passed as a parameter to the function. case ENCRYPT");
		errorDescs.add(MavenJar.findingType.FALSE_POSITIVE.toString() + " - repeated [case ENCRYPT]");
		errorDescs.add(MavenJar.findingType.FALSE_POSITIVE.toString() + " - repeated [case ENCRYPT]");
		errorDescs.add(MavenJar.findingType.FALSE_POSITIVE.toString() + " - repeated [case DECRYPT]");
		errorDescs.add(MavenJar.findingType.TRUE_POSITIVE.toString()
				+ " - There is no enough information to calculate if the parameter is generated properly. It is passed as a parameter to the function.");
		jar5.addErrors(
		...
		errorDescs.add(MavenJar.findingType.FALSE_POSITIVE.toString() + " - repeat (second parameter) [case DECRYPT]");
		errorDescs.add(MavenJar.findingType.TRUE_POSITIVE.toString()
		...
		errorDescs.add(MavenJar.findingType.FALSE_POSITIVE.toString() + " - repeat (second parameter) [case ENCRYPT]");
		errorDescs.add(MavenJar.findingType.FALSE_POSITIVE.toString() + " - repeat (third parameter) [case ENCRYPT]");
		errorDescs.add(MavenJar.findingType.FALSE_POSITIVE.toString() + " - repeat (third parameter) [case DECRYPT]");
		jar5.addErrors(
		...
		errorDescs.add(MavenJar.findingType.TRUE_POSITIVE.toString() + " - There is no enough information about the parameter.");
		jar5.addErrors(
				"<com.springcryptoutils.core.cipher.symmetric.CiphererWithStaticKeyImpl: void afterPropertiesSet()>",
				RequiredPredicateError.class, errorDescs);
		errorDescs.clear();

		errorDescs.add(MavenJar.findingType.TRUE_POSITIVE.toString() + " - There is no enough information about the parameter. [case DECRYPT]");
		errorDescs.add(MavenJar.findingType.FALSE_POSITIVE.toString() + " - repeat [case DECRYPT]");
		errorDescs.add(MavenJar.findingType.TRUE_POSITIVE.toString() + " - There is no enough information about the parameter. [case ENCRYPT]");
		errorDescs.add(MavenJar.findingType.FALSE_POSITIVE.toString() + " - repeat [case ENCRYPT]");
		jar5.addErrors(
		...
		errorDescs.add(MavenJar.findingType.TRUE_POSITIVE.toString() + " - value of secret (first parameter) is not initialized or not known. It is passed as a parameter.");
		jar6.addErrors(
